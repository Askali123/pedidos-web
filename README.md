...
- [Plan de PedidoProveedor](docs/PLAN_PEDIDO_PROVEEDOR.md) — Etapa 0 (modelo): definir el pedido a proveedor como documento persistido con `DetallePedidoProveedor` y snapshots, antes de migrar.
